...
\end{keyword}
\end{frontmatter}
    \ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, enhanced, borderline west={3pt}{0pt}{shadecolor}, sharp corners, breakable, interior hidden, boxrule=0pt]}{\end{tcolorbox}}\fi
...
The INCEPTION researchers have ddressed an important clinical question
...
often thought of as ``negative'' trials, null hypothesis significance
testing favors confusion ``between absence of evidence and evidence of
...
interpretation of new trial data, both in the situation of no and
considerable previous knowledge.

The overall message from this study is that standard statistical
analyses leading to a conclusion of ``similar survival effects'' may be
...
meaningful benefit, or even less likely the possibility of clinically
meaningful harm, has not been reasonably excluded and continued research
is necessary to clarifying the remaining uncertainties. The final
dilemma confronting clinicians is that even a Bayesian analysis of a
randomized trial provides only probability estimates of an average
treatment effect and not the elusive individual treatment effect.
